...
Twidor's original author is [Evan Dower](https://github.com/evantd).

[Rich Murphey](https://github.com/rich-murphey) modified the input file format to accept keyboard layouts
generated by the the official[Twiddler keyboard layout editor](https://twiddler.tekgear.com/tuner/edit.xhtml).
