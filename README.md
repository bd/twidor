...
One option for debuging Twidor is use [Eclipse](http://www.eclipse.org/downloads/). Select <kbd>File | Open | New Project</kbd>, then select "Java Project from Existing Ant Buildfile", click <kbd>Next</kbd>, click <kbd>Browse</kbd>, select file twidor/build.xml, and click <kbd>Finish</kdb>. 
