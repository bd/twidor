...
For example, given the text "ed", shown on the right. Twidor highlights the chord that sends "ed".
...
Arbitrary keymap files can be loaded by the user. Users  may load a custom key-map generated by the 
the [Twiddler Tuner](https://twiddler.tekgear.com/tuner/edit.xhtml) as follows:
