...
Users may select others in the <kbd>Keymaps</kbd> menu, or load a custom keymap generated by the 
the [official Twiddler layout editor](https://twiddler.tekgear.com/tuner/edit.xhtml).

Menu options include:
* <kbd>File | Load Keymap</kbd> imports a CSV file generated by the Twiddler Tuner.
* <kbd>File | Load Lesson</kbd> imports a arbitrary ascii text file, displayed one line at a time.
* <kbd>Keyboard | Show..</kbd> to show/hide button labels and/or Reverse the keyboard orientation.
* <kbd>Hints | Highlight...</kbd> to show/hide buttons   corresponding to the next letter in the lesson.
