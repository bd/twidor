...
width="30%" align="right"> To the right of each button, are two-button chords. This 2nd level keymap is oriented
the same as the top level button boxes: horizontally green-red-blue, and vertically index to pinky
finger.  For example, all two-button chords using the <kbd>I</kbd> key are:
