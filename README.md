...
The keymap shows the letters sent by each key.  Some letters require only a single key press, show by the large boxes. Other letters reqire several keys pressed simultaneously,
