...
To the right of each button, are two-button chords, oriented
horizontally green-red-blue, and vertically index to pinky
finger, same as the top level button boxes.  For example, all
...
* <kbd>I + SP</kbd> produces "C".
* <kbd>I + N</kbd> produces "in".
